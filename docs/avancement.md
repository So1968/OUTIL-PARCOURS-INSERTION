...
- Chaque professionnelle doit retrouver son espace de travail : dossiers � reprendre, alertes, actions, brouillons.
- La continuit� de service devient une fonction m�tier centrale.
- La Direction / CA reste un acc�s s�par�.
- Le logo ARTAG doit rester visible et lisible.
- L�interface doit �tre adapt�e au confort visuel de l�utilisatrice.

�tat actuel :
- HomePage refondue en bureau quotidien.
- Trois blocs principaux pos�s : Mon bureau, Mes acc�s m�tier, Continuit� de service.
- Bouton central : Reprendre un dossier.
- Direction / CA d�plac�e en bas � droite.
- Lisibilit� augment�e sur l�accueil.

Point de vigilance :
- Ne pas transformer l�accueil en tableau administratif froid.
- Garder une logique de travail quotidien : quoi reprendre, quoi suivre, quoi s�curiser.
- Adapter plus tard le contenu selon le profil connect� et les droits r�els.


## Continuit� de service

D�cision valid�e :
- La continuit� de service devient une fonction m�tier centrale de l�outil.
- Elle permet de reprendre temporairement les dossiers d�une coll�gue ou d�un coll�gue sans rupture pour la personne accompagn�e.
- Elle ne donne pas acc�s automatiquement � tout l�espace professionnel priv� de la coll�gue.
- Elle doit afficher uniquement les �l�ments n�cessaires � la continuit� : synth�se courte, note de continuit�, prochaine action, �ch�ances, documents attendus, relais mobilis�s.

�tat actuel :
- Une page `ContinuiteServicePage.jsx` a �t� cr��e.
- La route `/continuite-service` a �t� ajout�e.
- L�accueil contient un bouton vers la continuit� de service.
- Les donn�es affich�es sont fictives et servent uniquement � valider le mod�le fonctionnel.

Point de vigilance :
- Ne pas m�langer continuit� de service et surveillance.
- Ne pas ouvrir automatiquement les brouillons personnels, hypoth�ses sensibles ou notes priv�es.
- Plus tard, relier cette page aux droits r�els, aux r�les et aux dossiers effectivement rattach�s aux professionnelles.
