...
## Niveau 2
- modules ouverts
- socles très fragiles
- budget
- écrit / illettrisme
- numérique
- mobilité
- vie familiale
- synthèses mises à jour
...
## Vigilance
Les indicateurs de charge par professionnelle doivent être maniés comme outils de régulation d’équipe, pas comme contrôle individuel punitif.
